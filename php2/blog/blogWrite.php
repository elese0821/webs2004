...
<body class="gray"> 
    ...
    <main id="main" role="main">
        <div class="intro__inner blogStyle bmStyle container">
            ...
            <img srcset="../assets/img/intro01.jpg 1x, ../assets/img/intro01@2x.jpg 2x, ../assets/img/intro03@3x.jpg 3x" alt="인트로 이미지">
            </div>
                    ...
                    <form action="blogWriteSave.php" name="blogWriteSave" method="post" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <div class="file">
                                ...
                                <p>* jpg, gif, png, webp 파일만 넣을 수 있습니다. 이미지 용량은 1MB를 넘길 수 없습니다. accept=".jpg, .jpeg, .png, .gif, .webp"</p>
                            </div>
                            <div class="btn">
